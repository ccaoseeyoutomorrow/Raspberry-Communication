...
class Ultrasonic_Line():
    def __init__(self,Node_list_R,Node_list_T,file_time_name):
        ...
        self.bias = np.zeros(shape=(NodeA_num, NodeB_num))
        # self.bias2 = np.zeros(shape=(NodeA_num, NodeB_num))
...
def def_show():
    file_time_name=r'D://02_soft_temp/py_temp/树莓派数据通信/0111实验室数据/树莓派1524.txt'
